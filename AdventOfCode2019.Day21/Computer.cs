...
namespace AdventOfCode2019.Day21
{
    public class Computer
    {
        ...
        public IEnumerable<int> Run(IEnumerable<int> input = null)
        {
            input?.ToList().ForEach(_input.Enqueue);
        ...
        {
            _output.Add((int) GetValue(_program[_pointer + 1], mode1));
            _pointer += 2;
        }
